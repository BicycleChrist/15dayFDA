Gather the biotech data set via upcomingevents.py, or enter the ticker you want to gather price data for in tickerslist.txt, and then set use_file to true and use_events to false within urlmagic.py. 
